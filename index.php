...
<body>
    ...
    <main>
        ...
        <?php
            ...
            $lista_blanca = ['wip', 'links', 'wic', 'progfun', 'inmut', 'recurs', 'fnfstcls', 'fnosr', 'fnarrow', 'cveuse', 'closure', 'cllbck', 'fnpipe', 'fncpn', 'mitn', 'fnaymp', 'fnayfr', 'fnayre', 'fnut', 'fnayuf', 'fnaywk', 'pds', 'pdd', 'pdfm'];
